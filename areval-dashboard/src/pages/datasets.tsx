...
const datasets = [
  {
    ...
    description: "500 test cases covering core agent functionality",
    size: 500,
    tags: ["regression", "production", "critical"],
    format: "jsonl",
  ...
  },
  {
    ...
    description: "150 cases for testing tool selection and parameter accuracy",
    size: 150,
    tags: ["tools", "accuracy"],
    format: "jsonl",
  ...
  },
  {
    ...
    description: "200 RAG-focused cases with context and faithfulness checks",
    size: 200,
    tags: ["rag", "faithfulness", "relevance"],
    format: "jsonl",
  ...
  {
    id: "ds_004",
    name: "SWE-bench Subset",
    description: "Real GitHub issues for code agent evaluation",
    size: 100,
    tags: ["swe-bench", "code", "github"],
    format: "jsonl",
    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage evaluation test case collections</p>
        </div>
